...
const getFriendList = (url) => {
  return new Promise((resolve2, reject) => {
    var xhr = new XMLHttpRequest();
    xhr.onreadystatechange = function() {
      if (xhr.status === 200 && xhr.readyState === 4) {
        var friend2 = JSON.parse(xhr.responseText);
        resolve2(friend2);
      }
    };
    xhr.open("get", url);
...
const _hoisted_4 = { class: "friend-container" };
const _hoisted_5 = {
  class: "friend-container",
  style: { "margin-top": "20px" }
};
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_card_friend_item = resolveComponent("card-friend-item");
  const _component_common_friend_item = resolveComponent("common-friend-item");
  return openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.label, (value, key) => {
    return openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", null, [
        createBaseVNode("h3", _hoisted_2, toDisplayString(key), 1),
        createBaseVNode("p", _hoisted_3, toDisplayString(value.desc), 1)
      ]),
      createBaseVNode("div", _hoisted_4, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(value.card, (friend) => {
          return openBlock(), createBlock(_component_card_friend_item, {
            key: friend.number,
            friend
          }, null, 8, ["friend"]);
        }), 128))
      ...
      createBaseVNode("div", _hoisted_5, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(value.common, (friend) => {
          return openBlock(), createBlock(_component_common_friend_item, {
            key: friend.number,
            friend
          }, null, 8, ["friend"]);
        }), 128))
...
const _sfc_main = {
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      const friendList = [...result.gitee, ...result.github];
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_friend_template = resolveComponent("friend-template");
  return openBlock(), createBlock(_component_friend_template, { label: $setup.labels }, null, 8, ["label"]);
}
...
async function init(options = { url: "" }) {
